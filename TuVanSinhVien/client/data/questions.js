const questions = [
  {
    ...
    <strong>
        <em>
            Em định quy đổi điểm toeic tháng đơt 2 tháng 4 kì này hiện tại em K20 sẽ bị trừ bao nhiêu điểm và quy đổi được AV nào với số điểm toeic 510 ạ<div></div>
        </em>
    </strong>
</span>`,
    answer: `<span class="body">
    <strong>
        <em>
            Chào em,<div>Em đọc qui định 2930/QĐ-ĐHSPKT ngày 12/10/2020 sẽ xác định được điểm qui đổi Anh văn của em với số điểm TOEIC 510 nhé.</div><div>https://drive.google.com/file/d/1OwO4osMT-2kNu4JFJYrvy913OE4w1Kb4/view?pli=1<br></div><div>Thân chào</div>
        </em>
    </strong>
</span>`,
